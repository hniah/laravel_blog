...
<!-- ./ tabs -->
@if (isset($language))
    {!! Form::model($language, array('url' => url('admin/languages') . '/' . $language->id, 'method' => 'put', 'class' => 'bf', 'files'=> true)) !!}
@else
    {!! Form::open(array('url' => url('admin/languages'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
@endif
